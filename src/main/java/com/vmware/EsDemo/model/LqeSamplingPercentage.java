 ...
 * Time:14:54
 **/
public class LqeSamplingPercentage {
    ...
    public LqeSamplingPercentage(String ar_AE, String cs_CZ, String es_ES, String ja_JP, String zh_CN) {
        this.ar_AE = ar_AE;
        this.cs_CZ = cs_CZ;
        this.es_ES = es_ES;
        this.ja_JP = ja_JP;
