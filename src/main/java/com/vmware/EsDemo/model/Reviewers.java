...
public class Reviewers {
    ...
    public Reviewers(String ar_AE, String cs_CZ, String de_DE, String en_GB, String es_ES, String fr_FR, String ja_JP, String ko_KR, String pt_BR, String zh_CN, String zh_TW) {
        this.ar_AE = ar_AE;
        this.cs_CZ = cs_CZ;
        this.de_DE = de_DE;
        this.en_GB = en_GB;
