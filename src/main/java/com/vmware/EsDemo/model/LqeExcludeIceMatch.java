 ...
 * Time:14:45
 **/
public class LqeExcludeIceMatch {
    ...
    public LqeExcludeIceMatch(String ar_AE, String cs_CZ, String es_ES, String ja_JP, String zh_CN) {
        this.ar_AE = ar_AE;
        this.cs_CZ = cs_CZ;
        this.es_ES = es_ES;
        this.ja_JP = ja_JP;
